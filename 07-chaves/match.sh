...
egrep --color 'a{0,}b' chaves.txt

echo; colored_echo "a{0,}b" "não casa com:"
egrep -v 'a{0,}b' chaves.txt
...
egrep --color 'a{1,}b' chaves.txt

echo; colored_echo "a{1,}b" "não casa com:"
egrep -v 'a{1,}b' chaves.txt
...
egrep --color 'a{0,1}b' chaves.txt

echo; colored_echo "a{0,1}b" "não casa com:"
egrep -v 'a{0,1}b' chaves.txt
